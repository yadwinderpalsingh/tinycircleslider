...
(function (factory) {
    ...
    (function ($) {
        ...
        function Plugin($container, options) {
            ...
            , intervalTimer = null, animationTimer = null, touchEvents = 'ontouchstart' in window || 'onmsgesturechange' in window, isTouchEvent = false;
            ...
            function _setEvents() {
                ...
                $container.delegate(".dot", "mousedown", function (event) {
            ...
            function _setDots() {
                    ...
                    if ($(dot.dot).length > 0) {
                        if (index === 4) {
                            $(dot.dot)
                                ...
                                .html("<h1><div class='flip'>" + options.slides[index] + "</div></h1>");
                        } else {
                            $(dot.dot)
                                .addClass("dot-" + (index + 1))
                                .attr('data-slide-index', index)
                                .html("<h1><div>" + options.slides[index] + "</div></h1>");
                        }
                    }
                });
                ...
                $('h1').each(function (i, text) {
                    if ($(this).find('div').html() === "Deals") {
                        $(this).find('div').circleType({
                            radius: 130,
                            dir: -1
                        });
                    } else {
        ...
        $.fn[pluginName] = function (options) {
            return this.each(function () {
                if (!$.data(this, "plugin_" + pluginName)) {
                    ...
                    $(this).css('padding', '42px 45px 40px 41px');
                }
            });
        };
    })
